...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Nonchalant Thinker, EN T/F J, Compassionate Observer, Occasional Idealist',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, blog, Kristy Ma', // 网站关键词 英文逗号隔开
  ...
  BACKGROUND_DARK: '#333333', // use hex value, don't forget '#'
