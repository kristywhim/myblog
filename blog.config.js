...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'unorthodox go-getter, nonchalant bxxxxxd, sigma is my true identity',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'thoughtful whim,Kristy Ma unc,Krypton Ma,马玉帛',// 网站关键词 英文逗号隔开
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'IEyaxBKBNMcuYaLaYuadm',
