...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Unorthodox and Passionate, Nonchalant but Sweet, Sigma is my true identity',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'thoughtful whim,Kristy Ma unc,Krypton Ma,马玉帛','thoughtful whim','Kristy Ma','Krypton Ma','马玉帛',// 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,twitter,linkedin,wechat,instagram,messenger,facebook,telegram,reddit,whatsapp', // 分享的服務，按顺序显示,逗号隔开
  ...
  MOUSE_FOLLOW_EFFECT_COLOR: '#e3ded1', // 鼠标点击特效颜色 #xxxxxx 或者 rgba(r,g,b,a)
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'j5uUyP2ddS_hS_Irtz07P',
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-TPMEVVEGH8', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
